...
// --------------------------------------------------------------
$paths['app'] = '/var/www/laravel/application';

// --------------------------------------------------------------
// The path to the Laravel directory.
// --------------------------------------------------------------
$paths['sys'] = '/var/www/laravel/laravel';

// --------------------------------------------------------------
// The path to the bundles directory.
// --------------------------------------------------------------
$paths['globalbundle'] = '/var/www/laravel/bundles';

// --------------------------------------------------------------
// The path to the site directory.
// --------------------------------------------------------------
$paths['sitedir'] = '/var/www/example';

// --------------------------------------------------------------
// The path to the bundles directory.
// --------------------------------------------------------------
$paths['bundle'] = $paths['sitedir'].DIRECTORY_SEPARATOR.'bundles';

// --------------------------------------------------------------
// The path to the storage directory.
// --------------------------------------------------------------
$paths['storage'] = $paths['sitedir'].DIRECTORY_SEPARATOR.'storage';

// --------------------------------------------------------------
// The path to the public directory.
// --------------------------------------------------------------
$paths['public'] = $paths['sitedir'].DIRECTORY_SEPARATOR.'public';

// --------------------------------------------------------------
// The path to the config directory.
// --------------------------------------------------------------
$paths['configdir'] = $paths['sitedir'].DIRECTORY_SEPARATOR.'config';

// --------------------------------------------------------------
// The path to the templates directory.
// --------------------------------------------------------------
$paths['templatedir'] = $paths['public'].DIRECTORY_SEPARATOR.'templates';
